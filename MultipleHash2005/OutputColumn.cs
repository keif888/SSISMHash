...
#region OutputColumn
    ...
    #region AddColumnInformation
        ...
        public void AddColumnInformation(IDTSBufferManager90 bufferManager, IDTSOutput90 output, IDTSInput90 input, int outputColumnIndex)
        {
            ...
            IDTSOutputColumn90 outputColumn = output.OutputColumnCollection[outputColumnIndex];
