    ...
    class MultipleHashUI : DataFlowComponentUI
    {
        ...
        void form_GetInputColumns(object sender, InputColumnsArgs args)
        {
            ...
            try
            {
                ...
                IDTSVirtualInputColumnCollection90 virtualInputColumnCollection = this.VirtualInput.VirtualInputColumnCollection;
                ...
                {
                    IDTSVirtualInputColumn90 virtualInputColumn = virtualInputColumnCollection[i];
        ...
        void form_SetInputColumn(object sender, SetInputColumnArgs args)
        {
            ...
            try
            {
                ...
                IDTSVirtualInputColumn90 virtualInputColumn = args.VirtualColumn.Tag as IDTSVirtualInputColumn90;
                ...
                IDTSInputColumn90 inputColumn = this.DesigntimeComponent.SetUsageType(input.ID, this.VirtualInput, lineageId, DTSUsageType.UT_READONLY);
