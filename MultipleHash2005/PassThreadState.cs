...
namespace Martin.SQLServer.Dts
{
    ...
    public class PassThreadState
    {
        ...
        public PassThreadState(OutputColumn columnToProcess, PipelineBuffer buffer, IDTSComponentMetaData90 metaData, ManualResetEvent threadReset)
        {
        ...
        /// </summary>
        public IDTSComponentMetaData90 MetaData { get; set; }
    }
}
