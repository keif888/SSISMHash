...
namespace Martin.SQLServer.Dts
{
    ...
    public class MultipleHash : PipelineComponent
    {
        ...
        public override DTSValidationStatus Validate()
        {
            ...
            foreach (IDTSCustomProperty90 customProperty in ComponentMetaData.CustomPropertyCollection)
            {
        ...
        /// <param name="virtualInput">The IDTSVirtualInput90 for the input.</param>
        ...
        public override IDTSInputColumn90 SetUsageType(int inputID, IDTSVirtualInput90 virtualInput, int lineageID, DTSUsageType usageType)
        {
            ...
            IDTSVirtualInputColumn90 virtualCol = virtualInput.VirtualInputColumnCollection.GetVirtualInputColumnByLineageID(lineageID);
        ...
        {
            IDTSOutput90 output = ComponentMetaData.OutputCollection.FindObjectByID(outputID);
            IDTSOutputColumn90 outputColumn = output.OutputColumnCollection.NewAt(outputColumnIndex);
        ...
        public override IDTSCustomProperty90 SetOutputColumnProperty(int outputID, int outputColumnID, string propertyName, object propertyValue)
        {
            if (propertyName == Utility.HashTypePropName)
            {
                ...
                IDTSOutput90 output = ComponentMetaData.OutputCollection[0];
                IDTSOutputColumn90 outputColumn = output.OutputColumnCollection.FindObjectByID(outputColumnID);
        ...
        public override IDTSCustomProperty90 SetOutputProperty(int outputID, string propertyName, object propertyValue)
        {
        ...
        private bool ValidateColumnList(string inputLineageIDs, IDTSInputColumnCollection90 inputColumns)
        {
        ...
        private string FixColumnList(string inputLineageIDs, IDTSInputColumnCollection90 inputColumns)
        {
            string[] inputLineageArray;
        ...
        private bool ValidateDataType(IDTSOutputColumn90 outputColumn, int customPropertyIndex)
        {
        ...
        private void AddHashTypeProperty(IDTSOutputColumn90 outputColumn)
        {
            // Add the HashType property.
            IDTSCustomProperty90 hashProperty = outputColumn.CustomPropertyCollection.New();
        ...
        private void AddMultipleThreadProperty(IDTSComponentMetaData90 metaData)
        {
            // Add the Multi Thread Property
            IDTSCustomProperty90 multiThread = metaData.CustomPropertyCollection.New();
        ...
        private void AddInputLineageIDsProperty(IDTSOutputColumn90 outputColumn)
        {
            // Add the InputColumnLineageIDs property.
            IDTSCustomProperty90 inputColumnLineageIDs = outputColumn.CustomPropertyCollection.New();
